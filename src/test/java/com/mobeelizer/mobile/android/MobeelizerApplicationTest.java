...
public class MobeelizerApplicationTest {
    ...
    public void init() throws Exception {
        ...
        MobeelizerLoginResponse loginResponse = new MobeelizerLoginResponse(null, "0000", "role", false);
    ...
    public void shouldCreateInDevelopmentMode() throws Exception {
        ...
        assertEquals(null, application.login("anyInstance", "anyUser", "anyPassword"));
    ...
    public void shouldLoginFail() throws Exception {
        // given
        MobeelizerOperationError loginError = mock(MobeelizerOperationError.class);
        MobeelizerLoginResponse loginResponse = new MobeelizerLoginResponse(loginError);
        when(connectionManager.login()).thenReturn(loginResponse);

        // when
        MobeelizerOperationError login = application.login("instance", "user", "other-password");

        // then
        assertEquals(loginError, login);
    ...
    public void shouldLogin() throws Exception {
        // when
        MobeelizerOperationError error = application.login("instance", "user", "password");
    ...
    public void shouldLoginWithInitialSync() throws Exception {
        // when
        MobeelizerLoginResponse loginResponse = new MobeelizerLoginResponse(null, "0000", "role", true);
        when(connectionManager.login()).thenReturn(loginResponse);
        when(connectionManager.isNetworkAvailable()).thenReturn(true);
    ...
    public void shouldFailOnSyncWhenNotLoggedIn() throws Exception {
        // when
        MobeelizerOperationError error = application.sync();
    ...
    public void shouldFailOnSyncAllWhenNotLoggedIn() throws Exception {
        // when
        MobeelizerOperationError error = application.syncAll();
